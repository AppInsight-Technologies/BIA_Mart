...
Future<void> main() async {
  ...
  if(!PrefUtils.prefs!.containsKey("branch"))
    PrefUtils.prefs!.setString("branch", "85");
            ...
            builder: (BuildContext context, store, VxStatus? status) {
              return  MaterialApp.router(
                ...
                theme: ThemeData(
                  ...
                  primarySwatch: MaterialColor(0xff3E4095, {
                    50: Color(0xff3E4095),
                    100: Color(0xff3E4095),
                    200: Color(0xff3E4095),
                    300: Color(0xff3E4095),
                    400: Color(0xff3E4095),
                    500: Color(0xff3E4095),
                    600: Color(0xff3E4095),
                    700: Color(0xff3E4095),
                    800: Color(0xff3E4095),
                    900: Color(0xff3E4095),
                  }),
                  accentColor: MaterialColor(0xff3E4095, {
                    50: Color(0xff3E4095),
                    100: Color(0xff3E4095),
                    200: Color(0xff3E4095),
                    300: Color(0xff3E4095),
